...
const sampleData: DelegationData[] = [
  {
    id: 1,
    delegator: { name: "Validator X", icon: "X", color: "bg-red-500" },
  ...
  {
    id: 2,
    delegator: { name: "Crypto Node", icon: "⚡", color: "bg-blue-500" },
  ...
  {
    id: 3,
    delegator: { name: "Safe Stake", icon: "+", color: "bg-green-500" },
    validator: "0xabcd...89ef",
    amount: "1000 REP",
    time: "2 mins",
  ...
  {
    id: 4,
    delegator: { name: "Crypto Lord", icon: "≡", color: "bg-purple-600" },
  ...
  {
    id: 5,
    delegator: { name: "Rep Delegator", icon: "🦅", color: "bg-gray-600" },
    validator: "0xabcd...89ef",
    amount: "2500.456 REP",
    time: "35 mins",
  ...
  {
    id: 6,
    delegator: { name: "Rep Master", icon: "🦅", color: "bg-green-600" },
    validator: "0x1234...ef56",
    amount: "750.24 REP",
    time: "50 mins",
                  ...
                  <tr key={item.id} className="bg-[#0C0C0C] text-[#A8A8A8]">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className={`w-8 h-8 rounded-full ${item.delegator.color} flex items-center justify-center text-white text-sm font-bold mr-3`}>
                          {item.delegator.icon}
                        </div>
